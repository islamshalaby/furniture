...
Route::group(['middleware'=>'language','prefix' => "admin-panel",'namespace' => "Admin"] , function($router){
    ...
    Route::group(["prefix" => "ads"],function($router){
        ...
        Route::get('slider' , 'Ads\AdController@getSlider')->name('ads.slider');
        Route::get('sliders' , 'Ads\AdController@getSliders')->name('ads.sliders');
        Route::get('sliders/create' , 'Ads\AdController@getAddSlider')->name('ads.sliders.create');
        Route::get('sliders/edit/{id}' , 'Ads\AdController@getEditSlider')->name('ads.sliders.edit');
        Route::get('sliders/delete/{id}' , 'Ads\AdController@deleteSlider')->name('ads.sliders.delete');
        Route::get('sliders/details/{id}' , 'Ads\AdController@sliderDetails')->name('ads.sliders.details');
        
        Route::post('sliders/edit/{id}' , 'Ads\AdController@updatesSlider')->name('ads.sliders.update');
        Route::post('sliders/create' , 'Ads\AdController@postAddSlider')->name('ads.sliders.post');
