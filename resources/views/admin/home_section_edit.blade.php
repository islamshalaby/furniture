        ...
        <form action="" method="post" enctype="multipart/form-data" >
            ...
            <div class="form-group">
                ...
                <select id="type" name="type" class="form-control">
                    ...
                    <option {{ $data['home_section']['type'] == 1 ? 'selected' : '' }} value="1">{{ __('messages.slider') }}</option>
                    ...
                    <option {{ $data['home_section']['type'] == 5 ? 'selected' : '' }} value="5">{{ __('messages.offers') }}</option>
                </select>
            </div>
